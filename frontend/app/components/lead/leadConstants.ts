...
import type { FormStatus, LeadStatus } from "../../types"
...
export const STATUS_CONFIG: Record<LeadStatus, { label: string; cls: string; icon: ElementType }> = {
  ...
  quoted: { label: "Đã báo giá", cls: "bg-cyan-50 text-cyan-700 border-cyan-200", icon: Edit },
  contracted: { label: "Đã ký hợp đồng", cls: "bg-indigo-50 text-indigo-700 border-indigo-200", icon: CheckCircle2 },
