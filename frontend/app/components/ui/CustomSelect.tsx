          ...
          filteredOptions.map(opt => {
            ...
            return (
              <button
                ...
                className={`w-full px-4 py-2.5 text-left text-xs font-bold transition-colors flex items-center gap-2 block truncate ${color
                    ? isSelected ? color.active : color.base
                    : isSelected ? "bg-[#C62828]/5 text-[#C62828] dark:bg-[#C62828]/10" : "text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/10"
                  }`}
              >
                {color && (
      ...
      <button
        ...
        className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-xs font-bold ${heightClass} focus:outline-none transition-colors text-left
          ${currentColor
            ...
            : "border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-200 bg-white dark:bg-white/5 focus:border-[#C62828]/40 hover:bg-gray-50/50 dark:hover:bg-white/10"
          }
          ${disabled ? "opacity-60 cursor-not-allowed bg-gray-50 dark:bg-white/5 text-gray-400" : ""}
        `}
      >
